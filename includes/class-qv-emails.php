...
class QV_Emails {
    ...
    public function enviar_email_nuevo_viaje($post_id, $post, $update) {
    	...
    	//error_log("Destinatarios: " . print_r($recipients, true));

    	if (empty($recipients)) {
    		//error_log("QV_Emails: no hay destinatarios, no se envía.");
    		return;
    	}
    	...
    	foreach ($recipients as $to) {
    		...
    		//error_log("QV_Emails: correo enviado a $to con asunto: $subject");
    	}
    }
